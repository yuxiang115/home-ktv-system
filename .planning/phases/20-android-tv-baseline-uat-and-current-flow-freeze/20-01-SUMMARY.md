...
- Added baseline automated verification commands to `docs/deployment.md`.
...
```bash
rg -n "基线自动验证|pnpm -F @home-ktv/api typecheck|:app:testDebugUnitTest :app:assembleDebug" docs/deployment.md
