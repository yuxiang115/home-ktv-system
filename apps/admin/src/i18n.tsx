...
const dictionaries: Record<AppLanguage, Record<string, string>> = {
  en: {
    ...
    "ktvIndex.sectionLabel": "Index operations",
    "ktvIndex.title": "KTV index diagnostics",
    "ktvIndex.refresh": "Refresh diagnostics",
    "ktvIndex.loadFailed": "Failed to load KTV index diagnostics",
    ...
    "ktvIndex.noPreviewResults": "No KTV index results",
    ...
    "ktvIndex.syncedSources": "KTV synced sources",
  ...
  zh: {
    ...
    "ktvIndex.sectionLabel": "索引运维",
    "ktvIndex.title": "KTV 索引诊断",
    "ktvIndex.refresh": "刷新诊断",
    "ktvIndex.loadFailed": "KTV 索引诊断加载失败",
    "ktvIndex.tables": "索引表",
    ...
    "ktvIndex.noPreviewResults": "未找到 KTV 索引结果",
    "ktvIndex.exists": "存在",
    ...
    "ktvIndex.syncedSources": "KTV 同步来源",
