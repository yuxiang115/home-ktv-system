...
const dictionaries: Record<AppLanguage, Record<string, string>> = {
  en: {
    ...
    "dashboard.audioCodecs": "Audio formats",
    "dashboard.videoCodecs": "Video formats",
    "dashboard.videoResolutions": "Video resolutions",
    "dashboard.byAudioTracks": "By audio tracks",
    ...
    "songs.title": "Search preview",
    "songs.description": "Preview how indexed NAS songs appear in Admin and controller search.",
    "songs.catalogAria": "NAS search preview",
    ...
    "ktvIndex.title": "NAS search preview",
    "ktvIndex.refresh": "Refresh",
    "ktvIndex.loadFailed": "Failed to load NAS search preview",
    ...
    "ktvIndex.previewPlaceholder": "Search by song, artist, style, or filename",
    "ktvIndex.previewResults": "Preview results",
    "ktvIndex.resultCount": "{count} results",
    "ktvIndex.indexStatus": "Index status",
  ...
  zh: {
    ...
    "dashboard.audioCodecs": "音频格式",
    "dashboard.videoCodecs": "视频格式",
    "dashboard.videoResolutions": "视频分辨率",
    "dashboard.byAudioTracks": "按音轨数",
    ...
    "songs.title": "搜索预览",
    "songs.description": "预览 NAS 索引歌曲在后台和控制端搜索里的展示效果。",
    "songs.catalogAria": "NAS 搜索预览",
    "songs.listAria": "歌曲列表",
    ...
    "ktvIndex.title": "NAS 搜索预览",
    "ktvIndex.refresh": "刷新",
    "ktvIndex.loadFailed": "NAS 搜索预览加载失败",
    "ktvIndex.tables": "索引表",
    ...
    "ktvIndex.previewPlaceholder": "搜索歌名、歌手、风格或文件名",
    "ktvIndex.previewResults": "预览结果",
    "ktvIndex.resultCount": "{count} 条结果",
    "ktvIndex.indexStatus": "索引状态",
